...
=======
    def __init__(
        self, endpoint: str, address: str, batch_size: int = 100, max_transactions: int = 5000, output_file: str = None
    ):
>>>>>>> main
        """
    ...
    def load_progress(self):
        ...
        if self.progress_file.exists():
            with open(self.progress_file) as f:
                ...
                print(
                    f"Found saved progress - Offset: {progress['offset']}, Transactions: {len(progress['transactions'])}"
                )
                return progress
    ...
    def fetch_batch(self, offset: int, retries: int = 3):
        ...
        variables = {"limit": self.batch_size, "offset": offset, "types": "{}"}
